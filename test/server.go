...
func userAuthorizeHandler(w http.ResponseWriter, r *http.Request) (userID string, err error) {
	...
	uid := us.Get("UserID")
	log.Println(">>> /userAuthorizeHandler: UserId is ", uid)
	if uid == nil {
		if r.Form == nil {
			r.ParseForm()
		}
		us.Set("Form", r.Form)
		log.Println("++++++++++ : redirect to login. because UserId is nil.", uid)
...
func authHandler(w http.ResponseWriter, r *http.Request) {
	...
	log.Println(">>- LoggedInUserID is ", us.Get("LoggedInUserID"))
	...
	if r.Method == "POST" {
		...
		log.Println(">>- POST redirect TO authorize:", u.String())
